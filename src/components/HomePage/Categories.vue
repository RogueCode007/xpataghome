  ...
  <div class="px-3  py-8 lg:pb-12 lg:px-16 relative" style="background-color: #F2F2F2">
      <h1 class="text-3xl mb-6 font-bold dark">Our Categories</h1>
        ...
        <div class="mt-10 lg:flex lg:gap-6 mx-auto" style="max-width: 500px">
            <a href="https://expert.xpatag.com/signup" style="background: #52B95E;" class="block w-2/3 mx-auto text-sm rounded-3xl px-6 py-2 text-center text-white oultine-none focus:outline-none">Register as an expert</a>
            <a href="https://user.xpatag.com/signup" style="background: #fff;" class="block mt-4 lg:mt-0 w-2/3 mx-auto text-sm rounded-3xl px-6 py-2 text-center text-green-500 border border-solid border-green-500 oultine-none focus:outline-none">Register as a client</a>
        </div>
  </div>
</template>
